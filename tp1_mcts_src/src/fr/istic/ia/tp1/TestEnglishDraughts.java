...
public class TestEnglishDraughts {
	...
	public void testPossibleMovesInitBlack() {
		...
		assertEquals("Black should play after white", Game.PlayerId.TWO, draughts.player());
	...
	public void testWinner() {
		...
		assertEquals("Only blacks on board", Game.PlayerId.TWO, draughts.winner());
	}
	...
	public void test25MovesEquality() {
		...
		draughts.play(newMove(draughts, asList(22, 25))); // white king
		assertEquals("Equality", Game.PlayerId.NONE, draughts.winner());
	}
